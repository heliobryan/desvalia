...
class SubcriteriaMentalPage extends StatefulWidget {
  const SubcriteriaMentalPage({super.key});

  @override
  State<SubcriteriaMentalPage> createState() => _SubcriteriaMentalPageState();
}

class _SubcriteriaMentalPageState extends State<SubcriteriaMentalPage> {
  late Future<List<dynamic>> _subCriteriaFuture;
  Map<String, dynamic>? selectedSubcriteria;
  final int criterionId = 4;

  @override
  void initState() {
    super.initState();
    _subCriteriaFuture = getSubcriteria(criterionId: 4);
    _loadSubcriteria();
  }
            ...
            children: [
              ...
              Center(
                child: SizedBox(
                  ...
                  height: 60,
                  child: CustomPaint(
                    painter: TitleVetor('Avaliações Mentais'),
                  ),
                ),
              ),
